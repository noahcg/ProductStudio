...
export type GeneratedSignalType =
  ...
  | "money_monthly_high"
  | "money_ai_high"
  // Domain monitoring (generated by the DomainMonitoringService)
  | "domain_expiration"
  | "domain_expired"
  | "domain_autorenew_disabled"
  | "domain_ssl"
  ...
  | "github_api_failure"
  // Vercel integration (generated by the Vercel provider, not the core engine)
  ...
  // Supabase monitoring (generated by the Supabase provider, not the core engine)
  | "supabase_database_usage"
  | "supabase_storage_usage"
  | "supabase_bandwidth_usage"
...
export function computeSignals(input: SignalsInput, now: Date = studioNow()): GeneratedSignal[] {
  ...
  // Domain signals are generated by the DomainMonitoringService (merged in by
  // the data pipeline), not here.
