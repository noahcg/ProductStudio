...
export const roadmap: RoadmapItem[] = [
  // NOW
  { id: "r1", title: "Family Sharing MVP", projectId: "home-cooked", milestoneId: "m-home-cooked", column: "now", effort: "M", tag: "milestone" },
  { id: "r2", title: "Settings UI refresh", projectId: "home-cooked", column: "now", effort: "S" },
  { id: "r3", title: "Closet Import", projectId: "wardrobe-harmony", milestoneId: "m-wardrobe-harmony", column: "now", effort: "L", tag: "milestone" },
  // NEXT
  ...
  { id: "r6", title: "Client scheduling", projectId: "personal-trainer", milestoneId: "m-personal-trainer", column: "next", effort: "M", tag: "milestone" },
